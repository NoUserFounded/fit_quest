...
import '/fit_quest/fit_quest_util.dart' show routeObserver;
...
class fit_questVideoPlayer extends StatefulWidget {
  const fit_questVideoPlayer({
    super.key,
    required this.path,
  ...
  @override
  State<StatefulWidget> createState() => _fit_questVideoPlayerState();
}

class _fit_questVideoPlayerState extends State<fit_questVideoPlayer>
    with RouteAware {
  ...
  @override
  void didUpdateWidget(fit_questVideoPlayer oldWidget) {
