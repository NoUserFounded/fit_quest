...
abstract class fit_questTheme {
  ...
  static fit_questTheme of(BuildContext context) {
...
class LightModeTheme extends fit_questTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color tertiary = const Color(0xFF588157);
  late Color alternate = const Color(0xFF1E292F);
...
class DarkModeTheme extends fit_questTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
