...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: OfertesPageWidget.routeName,
          path: OfertesPageWidget.routePath,
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'OfertesPage')
              : NavBarPage(
                  initialPage: 'OfertesPage',
                  page: OfertesPageWidget(),
                ),
        ),
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Receptes')
              : ReceptesWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: ReptesListWidget.routePath,
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ReptesList')
              : NavBarPage(
                  initialPage: 'ReptesList',
                  page: ReptesListWidget(),
                ),
        ),
        FFRoute(
