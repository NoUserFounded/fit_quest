...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _fit_questButtonTabBarState tabBar;
...
/// A fit_quest Design widget that displays a horizontal row of tabs.
class fit_questButtonTabBar extends StatefulWidget
  ...
  /// and the entire [fit_questButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<fit_questButtonTabBar> createState() =>
      _fit_questButtonTabBarState();
}

class _fit_questButtonTabBarState extends State<fit_questButtonTabBar>
  ...
  @override
  void didUpdateWidget(fit_questButtonTabBar oldWidget) {
