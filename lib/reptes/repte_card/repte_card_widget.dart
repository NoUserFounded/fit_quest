...
import 'repte_card_model.dart';
export 'repte_card_model.dart';

class RepteCardWidget extends StatefulWidget {
  const RepteCardWidget({
    super.key,
  ...
  @override
  State<RepteCardWidget> createState() => _RepteCardWidgetState();
}

class _RepteCardWidgetState extends State<RepteCardWidget> {
  late RepteCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RepteCardModel());
  }
